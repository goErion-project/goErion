    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Elastic\ScoutDriver\Factories\DocumentFactoryInterface' => \Elastic\ScoutDriver\Factories\DocumentFactory::class,
            ...
            'Matchish\ScoutElasticSearch\Searchable\ImportSourceFactory' => \Matchish\ScoutElasticSearch\Searchable\DefaultImportSourceFactory::class,
...
'database.redis.cache.password','database.redis.cache.port','database.redis.cache.database','experience.multipliers.product_delivered','experience.multipliers.product_dispute_lost',
...
'scout.algolia.id','scout.algolia.secret','scout.meilisearch.host','scout.meilisearch.key','scout.typesense.client-settings.api_key',
'scout.typesense.client-settings.nodes.0.host','scout.typesense.client-settings.nodes.0.port','scout.elastic.client.hosts','scout.elastic.index','services.postmark.token',
...
'hashing.argon.threads','hashing.argon.time','hashing.argon.verify','hashing.rehash_on_login','elastic.client.default',
'elastic.client.connections.default.hosts','elastic.scout_driver.refresh_documents','elasticsearch.host','elasticsearch.user','elasticsearch.password',
'elasticsearch.cloud_id','elasticsearch.api_key','elasticsearch.ssl_verification','elasticsearch.queue.timeout','elasticsearch.indices.mappings.default.properties.id.type',
'elasticsearch.indices.settings.default.number_of_shards','elasticsearch.indices.settings.default.number_of_replicas','tinker.commands','tinker.alias','tinker.dont_alias',);
        registerArgumentsSet('middleware', 
'web','api',);
        registerArgumentsSet('routes', 
'generated::O6SfNofr5xQPRnhR','generated::7AD7tVJT7CRZu1Et','theme.dark','theme.light','auth.signin',
'auth.signin.post','auth.signup','auth.signup.post','auth.mnemonic','auth.',
'auth.generated::T2ZfWoDTRbWyTevy','auth.generated::urjaQs4HNlai8j9D','auth.generated::X3dWiUCJ3CfPfY0D','auth.generated::wHEEvogdBlcBOjWr','auth.pgprecover',
...
'validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','scout::flush.done','scout::import.start',
'scout::import.done','scout::import.done.queue',);
...
'SCOUT_DRIVER','ELASTICSEARCH_HOST','SCOUT_ELASTICSEARCH_INDEX',);
