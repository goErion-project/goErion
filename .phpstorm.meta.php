    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'FinalizeEarlyModule\Info' => \Modules\FinalizeEarly\main\Info::class,
            'FinalizeEarlyModule\Procedure' => \Modules\FinalizeEarly\main\Procedure::class,
    ...
    override(\config(), map([
            ...
            'auth.defaults.forgotpassword' => 'string',
            ...
            'cache.prefix' => 'string',
            'coins.coin_list.btc' => 'string',
            'coins.coin_list.xmr' => 'string',
            ...
            'scout.elastic.client.hosts' => 'array',
            'scout.elastic.index' => 'string',
...
'app.aliases.Module','auth.defaults.guard','auth.defaults.forgotpassword','auth.guards.web.driver','auth.guards.web.provider',
...
'auth.passwords.users.throttle','auth.password_timeout','auth.forgotpassword.users.provider','auth.forgotpassword.users.table','auth.forgotpassword.users.expire',
'auth.forgotpassword.users.throttle','cache.default','cache.stores.array.driver','cache.stores.array.serialize','cache.stores.database.driver',
...
'coins.coin_list.btc','coins.coin_list.xmr','coins.coin_list.stb','coins.bitcoin.host','coins.bitcoin.username',
'coins.bitcoin.password','coins.bitcoin.port','coins.bitcoin.minconfirmations','coins.monero.host','coins.monero.port',
'coins.monero.username','coins.monero.password','coins.pivx.host','coins.pivx.port','coins.pivx.username',
'coins.pivx.password','coins.litecoin.host','coins.litecoin.port','coins.litecoin.username','coins.litecoin.password',
'coins.dash.host','coins.dash.port','coins.dash.username','coins.dash.password','coins.bictoin_cash.host',
'coins.bictoin_cash.port','coins.bictoin_cash.username','coins.bictoin_cash.password','coins.xvg.host','coins.xvg.port',
'coins.xvg.username','coins.xvg.password','coins.caching_price_interval','coins.market_addresses.btc','coins.market_addresses.pivx',
'coins.market_addresses.dash','coins.market_addresses.xmr','coins.market_addresses.stb','coins.multisig.balance_api','coins.multisig.unspent_api',
'countries.AFG','countries.ALA','countries.ALB','countries.DZA','countries.ASM',
'countries.AND','countries.AGO','countries.AIA','countries.ATA','countries.ATG',
'countries.ARG','countries.ARM','countries.ABW','countries.AUS','countries.AUT',
'countries.AZE','countries.BHS','countries.BHR','countries.BGD','countries.BRB',
'countries.BLR','countries.BEL','countries.BLZ','countries.BEN','countries.BMU',
'countries.BTN','countries.BOL','countries.BES','countries.BIH','countries.BWA',
'countries.BVT','countries.BRA','countries.IOT','countries.BRN','countries.BGR',
'countries.BFA','countries.BDI','countries.KHM','countries.CMR','countries.CAN',
'countries.CPV','countries.CYM','countries.CAF','countries.TCD','countries.CHL',
'countries.CHN','countries.CXR','countries.CCK','countries.COL','countries.COM',
'countries.COG','countries.COD','countries.COK','countries.CRI','countries.CIV',
'countries.HRV','countries.CUB','countries.CUW','countries.CYP','countries.CZE',
'countries.DNK','countries.DJI','countries.DMA','countries.DOM','countries.ECU',
'countries.EGY','countries.SLV','countries.GNQ','countries.ERI','countries.EST',
'countries.ETH','countries.FLK','countries.FRO','countries.FJI','countries.FIN',
'countries.FRA','countries.GUF','countries.PYF','countries.ATF','countries.GAB',
'countries.GMB','countries.GEO','countries.DEU','countries.GHA','countries.GIB',
'countries.GRC','countries.GRL','countries.GRD','countries.GLP','countries.GUM',
'countries.GTM','countries.GGY','countries.GIN','countries.GNB','countries.GUY',
'countries.HTI','countries.HMD','countries.VAT','countries.HND','countries.HKG',
'countries.HUN','countries.ISL','countries.IND','countries.IDN','countries.IRN',
'countries.IRQ','countries.IRL','countries.IMN','countries.ISR','countries.ITA',
'countries.JAM','countries.JPN','countries.JEY','countries.JOR','countries.KAZ',
'countries.KEN','countries.KIR','countries.PRK','countries.KOR','countries.KWT',
'countries.KGZ','countries.LAO','countries.LVA','countries.LBN','countries.LSO',
'countries.LBR','countries.LBY','countries.LIE','countries.LTU','countries.LUX',
'countries.MAC','countries.MKD','countries.MDG','countries.MWI','countries.MYS',
'countries.MDV','countries.MLI','countries.MLT','countries.MHL','countries.MTQ',
'countries.MRT','countries.MUS','countries.MYT','countries.MEX','countries.FSM',
'countries.MDA','countries.MCO','countries.MNG','countries.MNE','countries.MSR',
'countries.MAR','countries.MOZ','countries.MMR','countries.NAM','countries.NRU',
'countries.NPL','countries.NLD','countries.NCL','countries.NZL','countries.NIC',
'countries.NER','countries.NGA','countries.NIU','countries.NFK','countries.MNP',
'countries.NOR','countries.OMN','countries.PAK','countries.PLW','countries.PSE',
'countries.PAN','countries.PNG','countries.PRY','countries.PER','countries.PHL',
'countries.PCN','countries.POL','countries.PRT','countries.PRI','countries.QAT',
'countries.REU','countries.ROU','countries.RUS','countries.RWA','countries.BLM',
'countries.SHN','countries.KNA','countries.LCA','countries.MAF','countries.SPM',
'countries.VCT','countries.WSM','countries.SMR','countries.STP','countries.SAU',
'countries.SEN','countries.SRB','countries.SYC','countries.SLE','countries.SGP',
'countries.SXM','countries.SVK','countries.SVN','countries.SLB','countries.SOM',
'countries.ZAF','countries.SGS','countries.SSD','countries.ESP','countries.LKA',
'countries.SDN','countries.SUR','countries.SJM','countries.SWZ','countries.SWE',
'countries.CHE','countries.SYR','countries.TWN','countries.TJK','countries.TZA',
'countries.THA','countries.TLS','countries.TGO','countries.TKL','countries.TON',
'countries.TTO','countries.TUN','countries.TUR','countries.TKM','countries.TCA',
'countries.TUV','countries.UGA','countries.UKR','countries.ARE','countries.GBR',
'countries.USA','countries.UMI','countries.URY','countries.UZB','countries.VUT',
'countries.VEN','countries.VNM','countries.VGB','countries.VIR','countries.WLF',
'countries.ESH','countries.YEM','countries.ZMB','countries.ZWE','database.default',
...
'database.redis.cache.password','database.redis.cache.port','database.redis.cache.database','elasticsearch.host','elasticsearch.user',
'elasticsearch.password','elasticsearch.cloud_id','elasticsearch.api_key','elasticsearch.ssl_verification','elasticsearch.queue.timeout',
'elasticsearch.indices.mappings.default.properties.id.type','elasticsearch.indices.settings.default.number_of_shards','elasticsearch.indices.settings.default.number_of_replicas','experience.multipliers.product_delivered','experience.multipliers.product_dispute_lost',
'experience.multipliers.feedback_per_star','experience.multipliers.feedback_per_usd','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/erion/goErion/public/storage',
...
'mail.markdown.paths','markdown.views','markdown.extensions','markdown.renderer.block_separator','markdown.renderer.inner_separator',
'markdown.renderer.soft_break','markdown.commonmark.enable_em','markdown.commonmark.enable_strong','markdown.commonmark.use_asterisk','markdown.commonmark.use_underscore',
'markdown.commonmark.unordered_list_markers','markdown.html_input','markdown.allow_unsafe_links','markdown.max_nesting_level','markdown.slug_normalizer.max_length',
'markdown.slug_normalizer.unique','marketplace.rsa_key_length','marketplace.mnemonic_length','marketplace.product_types','marketplace.market_fee_percent',
'marketplace.vendor_fee','marketplace.vendor_dwc_tag_count','marketplace.vendor_low_value_feedback','marketplace.trusted_vendor.min_lvl','marketplace.trusted_vendor.min_feedbacks',
'marketplace.trusted_vendor.percentage_of_feedback_positive','marketplace.products_per_page','marketplace.days_complete','marketplace.days_old_messages','marketplace.days_old_purchases',
'marketplace.seeder_coins','marketplace.js_warning','marketplace.mirrors','marketplace.front_page_cache.top_vendors','marketplace.front_page_cache.latest_orders',
'marketplace.front_page_cache.rising_vendors','marketplace.front_page_cache.featured_products','modules.namespace','modules.stubs.enabled','modules.stubs.path',
'modules.stubs.files.routes/web','modules.stubs.files.routes/api','modules.stubs.files.views/index','modules.stubs.files.views/master','modules.stubs.files.scaffold/config',
'modules.stubs.files.composer','modules.stubs.files.assets/js/app','modules.stubs.files.assets/sass/app','modules.stubs.files.vite','modules.stubs.files.package',
'modules.stubs.replacements.routes/web','modules.stubs.replacements.routes/api','modules.stubs.replacements.vite','modules.stubs.replacements.json','modules.stubs.replacements.views/index',
'modules.stubs.replacements.views/master','modules.stubs.replacements.scaffold/config','modules.stubs.replacements.composer','modules.stubs.gitkeep','modules.paths.modules',
'modules.paths.assets','modules.paths.migration','modules.paths.app_folder','modules.paths.generator.actions.path','modules.paths.generator.actions.generate',
'modules.paths.generator.casts.path','modules.paths.generator.casts.generate','modules.paths.generator.channels.path','modules.paths.generator.channels.generate','modules.paths.generator.class.path',
'modules.paths.generator.class.generate','modules.paths.generator.command.path','modules.paths.generator.command.generate','modules.paths.generator.component-class.path','modules.paths.generator.component-class.generate',
'modules.paths.generator.emails.path','modules.paths.generator.emails.generate','modules.paths.generator.event.path','modules.paths.generator.event.generate','modules.paths.generator.enums.path',
'modules.paths.generator.enums.generate','modules.paths.generator.exceptions.path','modules.paths.generator.exceptions.generate','modules.paths.generator.jobs.path','modules.paths.generator.jobs.generate',
'modules.paths.generator.helpers.path','modules.paths.generator.helpers.generate','modules.paths.generator.interfaces.path','modules.paths.generator.interfaces.generate','modules.paths.generator.listener.path',
'modules.paths.generator.listener.generate','modules.paths.generator.model.path','modules.paths.generator.model.generate','modules.paths.generator.notifications.path','modules.paths.generator.notifications.generate',
'modules.paths.generator.observer.path','modules.paths.generator.observer.generate','modules.paths.generator.policies.path','modules.paths.generator.policies.generate','modules.paths.generator.provider.path',
'modules.paths.generator.provider.generate','modules.paths.generator.repository.path','modules.paths.generator.repository.generate','modules.paths.generator.resource.path','modules.paths.generator.resource.generate',
'modules.paths.generator.route-provider.path','modules.paths.generator.route-provider.generate','modules.paths.generator.rules.path','modules.paths.generator.rules.generate','modules.paths.generator.services.path',
'modules.paths.generator.services.generate','modules.paths.generator.scopes.path','modules.paths.generator.scopes.generate','modules.paths.generator.traits.path','modules.paths.generator.traits.generate',
...
'modules.paths.generator.request.generate','modules.paths.generator.config.path','modules.paths.generator.config.generate','modules.paths.generator.factory.path','modules.paths.generator.factory.generate',
'modules.paths.generator.migration.path','modules.paths.generator.migration.generate','modules.paths.generator.seeder.path','modules.paths.generator.seeder.generate','modules.paths.generator.lang.path',
'modules.paths.generator.lang.generate','modules.paths.generator.assets.path','modules.paths.generator.assets.generate','modules.paths.generator.component-view.path','modules.paths.generator.component-view.generate',
'modules.paths.generator.views.path','modules.paths.generator.views.generate','modules.paths.generator.routes.path','modules.paths.generator.routes.generate','modules.paths.generator.test-feature.path',
'modules.paths.generator.test-feature.generate','modules.paths.generator.test-unit.path','modules.paths.generator.test-unit.generate','modules.auto-discover.migrations','modules.auto-discover.translations',
...
'modules.activators.file.statuses-file','modules.activator','queue.default','queue.connections.sync.driver','queue.connections.database.driver',
...
'scout.meilisearch.host','scout.meilisearch.key','scout.typesense.client-settings.api_key','scout.typesense.client-settings.nodes.0.host','scout.typesense.client-settings.nodes.0.port',
'scout.elastic.client.hosts','scout.elastic.index','services.postmark.token','services.ses.key','services.ses.secret',
...
'vendor.profile_bgs.weave','vendor.profile_bgs.stairs','vendor.profile_bgs.arrows','vendor.profile_bgs.zigzag','vendor.profile_bgs.carbon',
'vendor.profile_bgs.cross','vendor.profile_bgs.paper','vendor.profile_bgs.waves','vendor.profile_bgs.tablecloth','vendor.profile_bgs.seigaiha',
'vendor.profile_bgs.jcubes','vendor.profile_bgs.bricks','vendor.profile_bgs.checkerboard','vendor.profile_bgs.starrynight','vendor.profile_bgs.stars',
'vendor.profile_bgs.wave','vendor.profile_bgs.blueprint','view.paths','view.compiled','cors.paths',
'cors.allowed_methods','cors.allowed_origins','cors.allowed_origins_patterns','cors.allowed_headers','cors.exposed_headers',
'cors.max_age','cors.supports_credentials','broadcasting.default','broadcasting.connections.reverb.driver','broadcasting.connections.reverb.key',
...
'broadcasting.connections.log.driver','broadcasting.connections.null.driver','concurrency.default','hashing.driver','hashing.bcrypt.rounds',
'hashing.bcrypt.verify','hashing.bcrypt.limit','hashing.argon.memory','hashing.argon.threads','hashing.argon.time',
'hashing.argon.verify','hashing.rehash_on_login','tinker.commands','tinker.alias','tinker.dont_alias',);
...
'includes.admin.listcategories','includes.admin.menu','includes.captcha','includes.currency','includes.detailedsearch',
'includes.flash.error','includes.flash.invalid','includes.flash.success','includes.jswarning','includes.main',
'includes.modal','includes.paginate','includes.product.card','includes.product.row','includes.profile.addingform',
'includes.profile.basicform','includes.profile.deliveryform','includes.profile.digitalform','includes.profile.imagesform','includes.profile.menu',
'includes.profile.newticket','includes.profile.offersform','includes.profile.ticket','includes.profile.vendor.addproduct','includes.profile.vendor.editprofile',
'includes.profile.vendor.experience','includes.profile.vendor.products','includes.purchases.components.delivery','includes.purchases.components.dispute','includes.purchases.components.feedback',
'includes.purchases.components.message','includes.purchases.components.offer','includes.purchases.components.payment','includes.purchases.purchase','includes.purchases.stars',
'includes.search','includes.sidebar','includes.subcategories','includes.validation','includes.vendor.card',
'includes.vendor.feedback','includes.vendor.feedback_icon','includes.vendor.products','includes.vendor.stats','includes.viewpicker',
'layouts.admin','layouts.app','layouts.confirmation','layouts.navbar','layouts.navlink',
'layouts.product','layouts.productadding','layouts.profile','layouts.search','layouts.vendor',
'product.delivery','product.feedback','product.index','product.rules','product.vendor',
'profile.banned','profile.become','profile.bitmessage','profile.confirmpgp','profile.conversations',
'profile.index','profile.messagekey','profile.messages','profile.notifications','profile.oldpgp',
'profile.pgp','profile.product.confirmclone','profile.product.confirmdelete','profile.purchases.confirmcanceled','profile.purchases.confirmdelivered',
'profile.purchases.confirmsent','profile.purchases.index','profile.purchases.purchase','profile.purchases.viewmessage','profile.tickets',
'profile.vendor','profile.vendor.addbasic','profile.vendor.addderivery','profile.vendor.adddigital','profile.vendor.addimages',
'profile.vendor.addoffers','profile.vendor.sale','profile.vendor.sales','profile.wishlist','results',
'vendor.feedback','vendor.feedback.detailed','vendor.feedback.stats','vendor.index','welcome',
...
'SCOUT_QUEUE','SCOUT_DRIVER','ELASTICSEARCH_HOST','SCOUT_ELASTICSEARCH_INDEX','ELASTICSEARCH_SSL_VERIFICATION',);
