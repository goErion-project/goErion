...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/erion/goErion/public/storage','ide-helper.filename','ide-helper.models_filename',
...
'scout.typesense.client-settings.num_retries','scout.typesense.client-settings.retry_interval_seconds','scout.typesense.model-settings','markdown.views','markdown.extensions',
...
'markdown.max_nesting_level','markdown.slug_normalizer.max_length','markdown.slug_normalizer.unique','tinker.commands','tinker.alias',
'tinker.dont_alias',);
        registerArgumentsSet('middleware', 
'web','api',);
        registerArgumentsSet('routes', 'login','logout',
'register','password.request','password.email','password.reset',
'password.update','password.confirm','home','storage.local',);
        registerArgumentsSet('views', 
'auth.login','auth.passwords.confirm','auth.passwords.email','auth.passwords.reset','auth.register',
'auth.verify','home','layouts.app','welcome','laravel-exceptions-renderer::components.card',
