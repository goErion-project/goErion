...
class MoneroPayment implements Coin
{
     ...
     * @throws RuntimeException
     */
    public function sendToAddress(string $toAddress, float $amount): mixed
    {
        return $this->monero->transfer(['address' => $toAddress, 'amount' => $amount, 'priority' => 1]);
    }

    /**
     * Returns paymentID from an integrated address
     *
