...
class Mnemonic
{
    private array $dictionary =
        [
            ...
            'sympathy', 'thigh', 'throne', 'total', 'unseen', 'weapon', 'weary', 'whisper',
            'winter', 'witness', 'wonderful', 'worry', 'yell', 'zebra', 'zombie', 'abandon',

        ];

    private function randomword()
    {
        return $this->dictionary[array_rand($this->dictionary,1)];
    }
