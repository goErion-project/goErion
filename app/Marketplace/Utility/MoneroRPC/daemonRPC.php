...
use App\Marketplace\Utility\MoneroRPC\jsonRPCClient;
...
class daemonRPC
{
     ...
     * @param null $user Monero daemon RPC username           (optional)
     * @param null $password Monero daemon RPC passphrase         (optional)
     * @throws RuntimeException
     */
    function __construct(string $host = '127.0.0.1', int $port = 18081, string $protocol = 'http', $user = null, $password = null)
    {
