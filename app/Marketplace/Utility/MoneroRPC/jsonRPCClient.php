...
use App\Marketplace\Utility\MoneroRPC\Exceptions\InvalidArgumentException;
use App\Marketplace\Utility\MoneroRPC\Exceptions\RuntimeException;

class jsonRPCClient
{
    protected $url = null;
    protected string $parameters_structure = 'array';
    ...
    public function setDebug($pIsDebug): static
    {
    ...
    {
        of (in_array($pParametersStructure, array('array', 'object')))
        {
    ...
    public function _run($pMethod, $pParams) {
        ...
        // decode and create an array (can be objected, just set to false)
     ...
     * @throws RuntimeException
     */
    protected function & getResponse(&$pRequest): bool|string
    {
    ...
    function getJsonLastErrorMsg(): ?string
    {
        ...
        // Fix PHP 5.2 error caused by the missing json_last_error function
