...
trait Experience
{
    ...
    public function nextLevelProgress(): float|int
    {
    ...
    public function grantExperience($value): void
    {
        $this->experience += $value;
        $this->save();
    }
    public function takeExperience($value): void
    {
        $this->experience -= $value;
        $this->save();
    }

    public function getShortXP(): string
    {
