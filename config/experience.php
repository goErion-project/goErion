...
return [
    ...
    /**
     * Multipliers determine how much XP is granted to/taken from vendors for each action
     * XP is granted/taken by formulated USD value*multiplier
     *
     * Example:
     * product_delivered multiplier is 20
     * USD value of product is 100$
     *  When a vendor successfully delivers product he will receive 100*20=2000 XP
     */
    'multipliers' => [
        ...
        'feedback_per_star' => 2,
        // how much XP per USD value of transaction (given/taken based on a feedback type)
        'feedback_per_usd' => 5,
    ]
];
