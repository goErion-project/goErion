...
return [
    ...
    /**
     * Amount of USD that needs to be paid to the market to become a vendor
     */
    'vendor_fee' => env('VENDOR_FEE', 1),

    /**
     * After how much negative feedback should the vendor get "Deal with caution tag"?
     */
    ...
    /**
     * Trusted vendor settings (both conditions must be met to be displayed as trusted)
     */
    'trusted_vendor' => [
        'min_lvl' => 5,
        'min_feedbacks' => 1,
    ...
    /**
     * Every number of days a job will complete purchases with enough balances, you define this number here
     */
    ...
    /**
     * How many days from marking purchase as sent passed to the point of automatically marking the purchase as delivered and releasing the funds to the vendor?
     */
    ...
    /**
     * Display a warning for users to disable JavaScript if they have it enabled
     */
    'js_warning' => boolval(env('MARKETPLACE_JSWARNING',false)),


    /**
     * Mirrors of the marketplace
     */
    'mirrors' => [
