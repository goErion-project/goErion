            ...
            <table class="table table-hover table-striped">
                ...
                @foreach($items as $productId => $item)
                    <tr>
                        ...
                        <td class="text-center">
                            <span class="badge badge-info">{{ strtoupper(\App\Models\Purchase::coinDisplayName($item -> coin_name)) }}</span>
                        </td>
                        <td class="text-center">
                            <span class="badge badge-primary">{{ \App\Models\Purchase::$types[$item->type] }}</span>
