...
{{--        <!-- Brand -->--}}
{{--        <a class="navbar-brand fs-2 fw-extrabold text-brown-900 ps-2 ps-lg-4 fs-3xl" href="{{ route('home') }}" style="letter-spacing: 1px;">--}}
{{--            {{ config('app.name') }}--}}
{{--        </a>--}}
...
{{--                @csrf--}}
{{--                <div class="input-group">--}}
{{--                    <button class="btn btn-outline-dark bg-white hover:text-yellow-500 px-4" type="button" data-bs-toggle="dropdown" aria-expanded="false">--}}
{{--                        All--}}
{{--                    </button>--}}
{{--                    <ul class="dropdown-menu bg-white">--}}
{{--                        <li><a class="dropdown-item" href="#">Action</a></li>--}}
...
{{--                        <li><a class="dropdown-item" href="#">Separated link</a></li>--}}
{{--                    </ul>--}}
{{--                    <input class="form-control" type="text" placeholder="Search" id="search" name="Search" value="{{app('request')->input('query')}}">--}}
{{--                    <button class="btn btn-warning px-4" type="button">--}}
{{--                        <i class="fas fa-search"></i>--}}
{{--                    </button>--}}
{{--                </div>--}}
...
{{--            --}}{{-- Uncomment and add logic for moderators if necessary --}}
{{--            --}}{{-- @moderator --}}
{{--            <li class="nav-item @isroute('admin') active @endisroute">--}}
{{--                <a class="nav-link" href="{{ route('admin.index') }}">Moderator Panel</a>--}}
{{--            </li>--}}
...
{{--        <!-- User Authentication or Sign In / Sign Up -->--}}
{{--        <ul class="navbar-nav">--}}
{{--            @auth--}}
{{--                <li class="nav-item @isroute('profile.index') active @endisroute d-flex align-items-center">--}}
{{--                    <a class="nav-link px-2 d-flex align-items-center gap-2" href="{{ route('profile.index') }}">--}}
...
{{--                <li class="nav-item">--}}
{{--                    <form action="{{ route('auth.signout.post') }}" method="post" style="display: inline;">--}}
{{--                        @csrf--}}
{{--                        <button class="btn btn-dark text-white border-danger border ms-auto" type="submit" style="border-radius: 25px;">Logout</button>--}}
{{--                    </form>--}}
{{--                </li>--}}
{{--            @else--}}
{{--                <li class="nav-item d-flex gap-2 pe-5">--}}
{{--                    <a class="btn btn-outline-dark" href="{{ route('auth.signin') }}" style="border-radius: 25px;">Sign In</a>--}}
{{--                    <a class="btn btn-outline-dark" href="{{ route('auth.signup') }}" style="border-radius: 25px;">Sign Up</a>--}}
{{--                </li>--}}
{{--            @endauth--}}
{{--        </ul>--}}
{{--    </div>--}}
