...
@section('profile-content')
    ...
    <h1 class="mb-3 card rounded p-4 bg-gray-800 fw-bold text-gray-300 text-center">Purchases</h1>

    <ul class="nav nav-tabs nav-fill mb-3">
        <li class="nav-item">
            <a class="nav-link @if(!array_key_exists($state, \App\Models\Purchase::$states)) active @endif" href="{{ route('profile.purchases') }}">
